...
public class Mining {
    ...
    public void run() {
        ...
        IdeaSequenceDatabase sequenceDb = SequenceDatabases.fromFile("data\\sanitized\\dataset.idea", KeyType.SRC_IPV4);
        ...
        try (FileWriter writer = new FileWriter("data\\rules\\ruleDB")) {
            for (Rule rule : rules) {
